...
import setupReadGuardEdit, {
  readFiles,
  resolveToolPath,
} from "../extensions/read-guard-edit/index.ts";

describe("resolveToolPath", () => {
  const cwd = "/home/me/proj";
  it("resolves relative paths against cwd", () => {
    expect(resolveToolPath({ path: "src/a.ts" }, cwd)).toBe(
      "/home/me/proj/src/a.ts",
    );
  });
  it("honors the file_path key", () => {
    expect(resolveToolPath({ file_path: "b.ts" }, cwd)).toBe(
      "/home/me/proj/b.ts",
    );
  });
